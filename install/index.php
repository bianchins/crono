...
$db_config_path = '../api/application/config/database.php';
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Crono Time Tracker - Install</title>
    ...
    <center><h1><span style="font-family: 'Maven Pro', sans-serif;">Cr<i class="fa fa-clock-o"></i>no </span> installation</h1></center>
    <?php if(is_writable($db_config_path)){?>
        ...
        <fieldset>
          ...
          <input type="submit" value="Install" id="submit" class="btn btn-primary btn-lg btn-block" style="margin-top:10px;"/>
        </fieldset>
		  </form>
